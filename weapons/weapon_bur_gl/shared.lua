...
if CLIENT then
    SWEP.PrintName = "M79 Sensor Launcher"
    SWEP.Slot = 4
    SWEP.SlotPos = 0
...
--SWEP.Attachments = {[1] = {header = "Ammo", x = 500, y = 100, atts = {"slugrounds"}}}
...
-- Deploy related
SWEP.FirstDeployTime = 0.25
SWEP.DeployTime = 0.25
SWEP.HolsterTime = 0.25
SWEP.DeployAnimSpeed = 10
...
function SWEP:PrimaryAttack()	
	...
	if SERVER then
		...
		nade:GetPhysicsObject():SetVelocity((EA + Angle(self.CurCone * math.Rand(-25, 25), self.CurCone * math.Rand(-25, 25), 0)):Forward() * 9000)
